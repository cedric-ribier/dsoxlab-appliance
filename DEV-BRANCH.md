...
Current parked ideas (not started, not committed to any timeline):
...
- qcow2 output — likely the lowest-risk variant (same Debian build,
  different export post-processor).
